...
public class Data {
	...
	public int comparaCuDataCurenta() {
		...
		int rezultat=-9777;
		switch(luna){
		case "Jan": lunaInteger = 1;
		case "Feb": lunaInteger = 2;
		case "Mar": lunaInteger = 3;
		case "Apr": lunaInteger = 4;
		case "May": lunaInteger = 5;
		case "June": lunaInteger = 6;
		case "July": lunaInteger = 7;
		case "Aug": lunaInteger = 8;
		case "Sept": lunaInteger = 9;
		case "Oct": lunaInteger = 10;
		case "Nov": lunaInteger = 11;
		case "Dec": lunaInteger = 12;
		}
